...
class ConflictError(UkoreHubError):
    """Raised when a shared cloud-synced store (the app repo's own
    core/vcs/cloud_sync.py) detects that another machine wrote a newer
    version of the same blob first."""
