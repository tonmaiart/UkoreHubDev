...
from plugins.repo_internal.UkoreShot.core import comment_store
from plugins.repo_internal.UkoreShot.interface.comment_sidebar import CommentSidebar
from plugins.repo_internal.UkoreShot.interface.comment_thread import CommentThread
from plugins.repo_internal.UkoreShot.interface.draw_overlay import (
    TOOL_BRUSH,
    TOOL_ERASER,
    TOOL_SELECT,
    TOOL_TEXT,
...
_DEFAULT_FPS = 24
# plugins/repo_internal/UkoreShot/interface/player_widget.py, one parent up is
# plugins/repo_internal/UkoreShot/ itself (this plugin's own images/ folder, not
