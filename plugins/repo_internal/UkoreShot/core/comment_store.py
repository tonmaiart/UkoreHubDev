...
# sibling plugins.repo_internal.UkoreShot.core package — same name, different
...
# location) — see plugins/repo_internal/UkoreShot/core/README.md's note on this.
from core.store import LocalConfigStore

_SUFFIX = ".ukoreshot.json"
# plugins/repo_internal/UkoreShot/core/comment_store.py, four parents up is the
