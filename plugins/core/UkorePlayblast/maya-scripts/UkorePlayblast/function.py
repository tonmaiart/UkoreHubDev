...
Playblast" (plugins/core/MayaToolkit/maya-scripts/UkoreMaya/core/
...
# is also what lets plugins/core/UkoreShot/video_naming.py (the
...
def _resolve_video_root(project_id: str, repo_id: str, repo_path):
    """Mirrors plugins/core/UkoreShot/video_path_store.py's
    ...
    ukore_shot_store = PluginConfigStore(root / "data" / "plugins" / "core" / "ukore_shot.json")
