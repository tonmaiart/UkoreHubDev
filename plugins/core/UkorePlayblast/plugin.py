...
# pattern plugins/core/RigPublisher/plugin.py uses for its own Maya
# package.
...
def register(api) -> None:
    ...
    # its own" reasoning plugins/core/maya_launcher/plugin.py's own
    # PUBLISH_API_TOOL_ID comment gives for plugins/core/PublishApi).
