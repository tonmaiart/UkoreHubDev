...
def find_ukorehub_root() -> Path:
    ...
    plugins/core/PublishApi/maya-scripts/PublishApi/repo_paths.py — five
    ...
    same trick plugins/core/UkoreBrowser/.../core/repo_context.py uses
...
def get_pipeline_refs() -> list[dict]:
    ...
    plugins/core/UkoreBrowser/.../core/repo_context.py's
