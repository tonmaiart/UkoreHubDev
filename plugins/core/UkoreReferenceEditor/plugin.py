...
def register(api) -> None:
    tool_root = api.app_root / "plugins" / "core" / "UkoreReferenceEditor"
    ...
    contributions[TOOL_ID] = {
        ...
        # plugins/core/PublishApi/plugin.py and
        # plugins/core/UkoreBrowser/plugin.py contribute api.app_root too.
