...
# plugins/core/PublishApi/README.md for why the publish root is now
...
class MainWindow(ToolkitWindow):
    ...
    def _add_manage_tickets_button(self):
        ...
        identically (ModelPublisher/AnimationPublisher's own interface.py
    ...
    def open_ticket_manager(self):
        dialog = TicketManagerDialog(self, tool_id=function.TOOL_ID, tool_label="RigPublisher")
        dialog.exec_()
        self.initialize_ticket_list_widget()
        self.refresh_publish_destination()
