...
from plugins.core.UkoreShot.core import comment_store
from plugins.core.UkoreShot.interface.comment_sidebar import CommentSidebar
from plugins.core.UkoreShot.interface.comment_thread import CommentThread
from plugins.core.UkoreShot.interface.draw_overlay import (
    TOOL_BRUSH,
    TOOL_ERASER,
    TOOL_SELECT,
    TOOL_TEXT,
...
_DEFAULT_FPS = 24
# plugins/core/UkoreShot/interface/player_widget.py, one parent up is
# plugins/core/UkoreShot/ itself (this plugin's own images/ folder, not
