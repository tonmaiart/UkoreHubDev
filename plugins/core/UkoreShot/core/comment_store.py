...
# sibling plugins.core.UkoreShot.core package — same name, different
...
# location) — see plugins/core/UkoreShot/core/README.md's note on this.
from core.store import LocalConfigStore

_SUFFIX = ".ukoreshot.json"
# plugins/core/UkoreShot/core/comment_store.py, four parents up is the
