...
gating needed. Companion to `plugins/core/UkorePlayblast/`, which
...
`plugins/core/UkorePlayblast/`'s output folder.
...
`plugins/core/UkorePlayblast/`'s output (read-only, both plugins just
