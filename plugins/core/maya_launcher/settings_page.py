...
# Convention-only string match with plugins/core/PublishApi/plugin.py's
# own TOOL_ID and plugins/core/maya_launcher/plugin.py's
...
class MayaLauncherSettingsPage(QWidget):
    ...
    plugins/core/maya_launcher/README.md for the bridge shape."""
