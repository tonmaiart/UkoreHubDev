...
from plugins.core.maya_launcher.link_resolution import linked_key, pinned_version
from plugins.core.maya_launcher.repo_tools_store import RepoToolsStore
from plugins.core.maya_launcher.settings_page import MayaLauncherSettingsPage
...
# plugins/core/project_editor/'s "core": true manifest flag makes IT
...
# Convention-only string match with plugins/core/UkoreReferenceEditor/plugin.py's
...
def _set_project_and_open_command(repo_root: Path, scene_path: Path, defer_reference_load: bool = False) -> str:
    ...
    plugins/core/UkoreReferenceEditor is enabled for the launching repo
