...
def register(api) -> None:
    tool_root = api.app_root / "plugins" / "studio" / "UkoreReferenceEditor"
    ...
    contributions[TOOL_ID] = {
        ...
        # plugins/studio/PublishApi/plugin.py and
        # plugins/studio/UkoreBrowser/plugin.py contribute api.app_root too.
