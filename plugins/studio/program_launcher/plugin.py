...
# plugins/studio/maya_launcher uses to find a linked executable.
...
def _linked_key(program: Program, version: str = "") -> str:
    ...
    Convention-only duplicate of plugins/studio/software_linker/plugin.py's
    own _linked_key() (and plugins/studio/maya_launcher/link_resolution.py's
